"""
Basic test to verify the Phase II implementation works as expected.
"""
import os
...
def test_basic_functionality():
    """Test basic functionality of the task manager with persistence."""
    print("Testing basic functionality with persistence...")
    
    # Set environment to use memory backend for testing
